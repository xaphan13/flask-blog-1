...
- [`docs/setup-and-run.md`](docs/setup-and-run.md) — авторитетный, проверенный отчёт по
  настройке и разбору проблем (рус.), с полными таблицами переменных окружения.
- [`AGENTS.md`](AGENTS.md) / [`AGENTS.ru.md`](AGENTS.ru.md) — соглашения и «грабли» для
