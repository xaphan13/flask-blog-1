...
Контекст-инструкция для AI-агентов, работающих в этом репозитории.
...
```bash
python -c "from flaskblog import create_app; print(create_app().url_map)"   # ожидается 13 правил
